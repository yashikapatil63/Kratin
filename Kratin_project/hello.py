...
def upload():
    ...
    for upload in request.files.getlist("file"):
        ...
        if(prediction=="NORMAL"):
            prediction="Your results are NEGATIVE.Your Lungs are NORMAL. "
        if(prediction=="Lung_Opacity"):
            prediction="Your results of Lung Opacity are POSITIVE."
        if(prediction=="Viral Pneumonia"):
            prediction="Your results of Viral Pneumonia are POSITIVE."
        if(prediction=="COVID"):
